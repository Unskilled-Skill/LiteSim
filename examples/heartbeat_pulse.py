"""
Rhythmic heartbeat pulse: short, subtle compression/expansion synced to a beat.
Uses a cubed sine for sharper peaks; J2/J3/J5 participate.
"""
import math
import time
...
def main(ip=None):
    ...
    try:
        while True:
            ...
            env = envelope(t)
            pulse = math.sin(2 * math.pi * BEAT_HZ * t) ** 3
